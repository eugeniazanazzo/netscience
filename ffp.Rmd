...
## Data challenges
1. Quali sono le squadre *hub* e quali sono le squadre *authority* nel sistema attuale?
...
Andiamo ad analizzare quali sono le relazioni preferenziali che possono essere osservate sul mercato
...
plot(g3,vertex.label=V(g3)$label,layout = coord,
     vertex.shape = c("circle",rep("square",4)),vertex.size=80,curved=TRUE)
```

Nonostante la forma della nostra rete sia riconducibile a quella del grafo del web, notiamo come non ci sia la stessa regolarità nelle dimensioni delle varie componenti. Infatti la SCC ha meno nodi rispetto alla sua *in-component*, mentre l' *out-component* è composta da soli 32 nodi.
Notiamo inoltre come le ipotesi che avevamo fatto sulla composizione dell'*in-component* sia sbagliata. L'*in-component* è infatti è composta principalmente da squadre europee e non da squadre extra-europee come avevamo ipotizzato. Queste sono squadre la cui posizione è meno consolidat L'*out-component*
